...
namespace DoAnCoSo.Migrations
{
    ...
    [Migration("20250523031438_ngay23_5moinhathaha")]
    partial class ngay23_5moinhathaha
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoAnCoSo.Models.ThongKeDoanhThu", b =>
                {
            ...
            modelBuilder.Entity("DoAnCoSo.Models.DanhGia", b =>
                {
                    b.HasOne("DoAnCoSo.Models.KhachHang", "KhachHang")
                        .WithMany("DanhGias")
                        .HasForeignKey("MaKhachHangID")
                        .OnDelete(DeleteBehavior.Restrict);
